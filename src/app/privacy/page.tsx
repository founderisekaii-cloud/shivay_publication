...
export const metadata = {
  title: 'Privacy Policy | Shivay Publication',
};
    ...
    <div className="min-h-screen bg-background pb-20">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="text-lg text-gray-300">
              Understanding how we protect your personal and institutional research data.
            </p>
          </AnimatedSection>
        </div>
      </section>
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <AnimatedSection delay={0.2} className="bg-white p-10 rounded-xl shadow-lg border border-gray-100 min-h-[400px]">
           <p className="text-gray-600 text-lg text-center mt-20">The full Privacy Policy document is currently being finalized.</p>
        </AnimatedSection>
      </section>
    </div>
  );
